# Arduplotter
A (hopefully) simple python library to help generate live updating charts
based on input received from an arduino board.
## Getting started
...
## How to use
Take a look at the following example and notice how easy it really is:
```python
